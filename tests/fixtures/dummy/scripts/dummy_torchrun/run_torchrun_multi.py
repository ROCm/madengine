...
Usage:
  torchrun --standalone --nproc_per_node=1 run_torchrun_multi.py
...
IMAGE_SIZE = 224
NUM_CLASSES = 1000
MULTI_RESULTS_CSV = "perf_dummy_torchrun.csv"
...
def print_header():
    ...
    print("=" * 70)
    print("madengine PyTorch Distributed Training Benchmark (multi_results)")
    print("=" * 70)
