...
class TestROCmToolManager:
    ...
    def test_get_rocm_version_from_hipconfig(self):
        ...
        with (
            patch.object(manager, "is_tool_available", return_value=True),
    ...
    def test_get_gpu_count_with_amd_smi(self):
        ...
        with (
            patch.object(manager, "get_preferred_smi_tool", return_value="amd-smi"),
    ...
    def test_get_gpu_product_name_with_fallback(self):
        ...
        with (
            patch.object(manager, "get_preferred_smi_tool", return_value="amd-smi"),
            patch.object(
                manager, "execute_command", return_value="AMD Instinct MI300X"
            ),
        ):
...
class TestToolManagerIntegration:
    ...
    def test_context_uses_tool_manager_for_gpu_count(self):
        ...
        with (
            patch("madengine.core.context.Context.get_gpu_vendor", return_value="AMD"),
            patch(
...
class TestGetGpuRenderDNodesIntegration:
    ...
    def test_returns_none_for_non_amd_gpu(self):
        ...
        with (
            patch.object(Context, "get_gpu_vendor", return_value="NVIDIA"),
