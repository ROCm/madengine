...
class TestLoadEnvFile:
    ...
    def test_shell_constructs_are_evaluated(self, env_dir):
        ...
        assert loaded["MAD_DOCKER_BUILDS"] == "/shared/MADstorage/docker_builds"
        assert loaded["MAD_PARTITION"] == "meta64"
    ...
    def test_inherited_value_wins_over_default(self, env_dir, monkeypatch):
        ...
        env_file = env_dir / "mad.env"
        env_file.write_text('MAD_PARTITION="${MAD_PARTITION:-meta64}"\n')
