...
> `--additional-context-file`. Job YAML uses the same top-level keys as JSON
> additional-context (`slurm`, `distributed`, `env_vars`, …), not a Hydra
> `defaults:` list. See `docs/configuration.md`.
