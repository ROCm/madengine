...
def validate_gpu_installation(vendor: Optional[GPUVendor] = None, verbose: bool = False, raise_on_error: bool = True, rocm_path: Optional[str] = None) -> GPUValidationResult:
...
def validate_rocm_installation(verbose: bool = False, raise_on_error: bool = True, rocm_path: Optional[str] = None) -> GPUValidationResult:
    ...
    Raises:
        GPUInstallationError: If validation fails and raise_on_error is True
    """
    return validate_gpu_installation(vendor=GPUVendor.AMD, verbose=verbose, raise_on_error=raise_on_error, rocm_path=rocm_path)
